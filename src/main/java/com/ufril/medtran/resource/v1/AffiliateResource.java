...
public class AffiliateResource {
    private static Logger logger = Logger.getLogger(AffiliateResource.class);

    @Autowired
    private AffiliateService affiliateService;

    @ApiOperation(
            value = "Get All Affiliate",
    ...
    @RequestMapping(
            value = "/affiliate/getAllAffiliate",
            method = RequestMethod.GET
    )
    public ResponseEntity<?> getAllAffiliate() {
        List<Affiliate> affiliateList = affiliateService.getAllAffiliate();
